        ...
        <div className='order-last flex gap-4 lg:order-none lg:flex-col'>
            {images.map((image: any, idx: any) => (
                <div key={idx} className="overflow-hidden rounded-lg bg-gray-100">
                    <Image src={urlFor(image).url()} width={200} height={200} alt="picture" className='h-full w-full object-cover object-center cursor-pointer' onClick={() => handleSmallImageClick(image)}/>
                </div>
            ))}
        </div>
